      ...
      <div className="container max-w-screen-xl mx-auto p-4">
        <div className="flex items-center justify-center ">
          <div className="anim-bounce w-96 p-4 flex flex-col items-center justify-center  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <form onSubmit={handleRegister} name="registrationForm" className="flex flex-wrap items-center justify-center gap-4 my-4">
              ...
              <div class="mb-5 w-full">
                ...
                <input type="password" name="confirmPassword" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  required autoComplete="off" />
              </div>
              ...
              {/* <input className="w-full p-2 border rounded" type="text" name="name" autoComplete="off" placeholder="Nasir Uddin" required/>
              <input className="w-full p-2 border rounded" type="email" name="email" autoComplete="off" placeholder="nasir@example.com" required/>
              <input className="w-full p-2 border rounded" type="password" name="password" autoComplete="off" placeholder="Password" required/>
              <input className="w-full p-2 border rounded" type="password" name="confirmPassword" autoComplete="off" placeholder="Confirm Password" required/>
              <button className="w-full p-2 bg-sky-500 text-white font-bold rounded hover:scale-95 focus:scale-95 transition">Register</button> */}
            </form>
